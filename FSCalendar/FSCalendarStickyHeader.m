...
- (void)setMonth:(NSDate *)month
{
    ...
    BOOL usesCapitalizedCase = (self.calendar.appearance.caseOptions & FSCalendarCaseOptionsHeaderUsesCapitalizedCase) == FSCalendarCaseOptionsHeaderUsesCapitalizedCase;
